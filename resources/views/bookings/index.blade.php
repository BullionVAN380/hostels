                ...
                <div class="p-6">
                    @if($bookings->isEmpty())
                        <div class="text-center py-8">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">No Bookings Yet</h3>
                            <p class="text-gray-600 dark:text-gray-400 mb-4">You haven't made any room bookings yet.</p>
